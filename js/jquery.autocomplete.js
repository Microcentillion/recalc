...
(function ($) {
    ...
    Autocomplete.prototype = {
        ...
        initialize: function () {
            ...
            $('<div id="' + this.mainContainerId + '" style="position:absolute;z-index:9999;"><div class="autocomplete-w1"><div class="autocomplete_autocomplete" id="' + autocompleteElId + '" style="display:none; width:300px;"></div></div></div>').appendTo('body');
        ...
        suggest: function () {
            ...
            for (i = 0; i < len; i++) {
                ...
                div = $((me.selectedIndex === i ? '<div class="autocomplete_selected"' : '<div') + ' title="' + s + '">' + f(s, this.data[i], v) + '</div>');
        ...
        activate: function (index) {
            ...
            if (this.selectedIndex !== -1 && divs.length > this.selectedIndex) {
                ...
                $(activeItem).addClass('autocomplete_selected');
                return activeItem;
            }
